window.catalog = [{
    ...
    colors: ['Black', 'White'],
    sizes: ['UK 18'],
    thumbnail: "img/catalog3.png", // replace with path to image extracted from catalog layout
    ...
    colors: ['Black', 'White'],
    sizes: ['UK 18'],
    thumbnail: "img/catalog1.png", // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Black', 'White'],
    sizes: ['UK 18'],
    thumbnail: "img/catalog7.png", // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Blue'],
    sizes: ['UK 18'],
    thumbnail: "img/LevJeans.png", // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Blue'],
    sizes: ['UK 18'],
    thumbnail: "img/NewAr4.png", // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    thumbnail: 'img/full1', // replace with image extracted from item layout
    preview: ['img/full1', 'img/full2', 'img/full3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Green'],
    sizes: ['UK 19'],
    thumbnail: "img/DinNewAr2.png", // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    thumbnail: 'img/DinNewAr1.png', // replace with image extracted from item layout
    preview: ['img/DinNewAr1.png', 'img/DinNewAr1_1.png', 'img/DinNewAr1_2.png'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Black', 'Blue', 'Gray'],
    sizes: ['UK 17', 'UK 18', 'UK 19'],
    thumbnail: "img/NewAr3.png", // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Dark Blue'],
    sizes: ['UK 19'],
    thumbnail: "img/catalog6.png", // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Dark Blue'],
    sizes: ['UK 19'],
    thumbnail: "img/catalog2.png", // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 18', 'UK 19'],
    thumbnail: "img/catalog4.png", // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Blue'],
    sizes: ['UK 18'],
    thumbnail: "img/catalog5.png", // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}];
